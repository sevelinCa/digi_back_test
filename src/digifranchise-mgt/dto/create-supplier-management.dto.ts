...
export class UpdateSupplierManagementDto {
    @IsOptional()
    @IsString()
    @ApiProperty({ example: 'MUGABO James', description: 'The name of the supplier' })
    fullNames?: string;

    @IsOptional()
    @IsEmail()
    @ApiProperty({ example: 'john.doe@example.com', description: 'The email of the supplier' })
    email?: string;

    @IsOptional()
    @IsString()
    @Length(10, 15)
    @ApiProperty({ example: '1234567890', description: 'The mobile number of the supplier' })
    mobile_number?: string;
    ...
    @IsOptional()
    @IsString()
    @ApiProperty({ example: '123 Main St, Anytown, Anywhere', description: 'The address of the supplier' })
    address?: string;
}