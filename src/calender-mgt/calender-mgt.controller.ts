...
export class CalenderMgtController {
  ...
  @ApiResponse({
    ...
    description: "You have created Venue.",
  })
  ...
  async createVenue(
    ...
    return this.calenderMgtService.createVenue(
      createVenueDto,
      ownedFranchiseId,
    );
  }
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: "You have recorded a new booking.",
  })
  ...
  async recordBooking(
    ...
    return this.calenderMgtService.recordBooking(
      userId,
      eventId,
      createBookingDto,
    );
  ...
  async getEventOwnerById(
    @Param("eventOwnerId") eventOwnerId: string,
  ...
  @ApiResponse({
    status: 201,
    description: "The customer has been successfully added to the event.",
  })
  ...
  @ApiResponse({
    status: 200,
    description:
      "The list of customers for an event has been successfully retrieved.",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "The customer for an event has been successfully retrieved.",
  })
  ...
  @ApiResponse({
    status: 204,
    description: "The customer has been successfully removed from the event.",
  })
  ...
  @ApiOperation({
    summary: "DELETE - Remove a guest from a specific event by ID",
  })
  @ApiResponse({
    status: 204,
    description:
      "The guest has been successfully removed from the specified event.",
  })
  ...
  async removeGuestFromEvent(
    ...
    try {
      ...
      throw new InternalServerErrorException(
        "An error occurred while removing the guest from the event.",
      );
    }
  }
