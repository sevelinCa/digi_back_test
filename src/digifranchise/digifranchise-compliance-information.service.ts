...
export class DigifranchiseComplianceInfoService {
  ...
  async getDigifranchiseComplianceInformation(
    userId: string,
    ownedDigifranchiseId: string,
  ): Promise<DigifranchiseComplianceInfo> {
    const digifranchiseComplianceInfo =
  ...
  async updateDigifranchiseComplianceInformation(
    userId: string,
    dto: UpdateDigifranchiseComplianceInfoDto,
    ownedDigifranchiseId: string,
  ): Promise<DigifranchiseComplianceInfo> {
    const digifranchiseComplianceInfo =
      await this.digifranchiseComplianceInfoRepository.findOne({
    ...
    digifranchiseComplianceInfo.companyRegisterationNumber =
      dto.companyRegisterationNumber;
    ...
    (digifranchiseComplianceInfo.taxClearenceExpiration =
      dto.taxClearenceExpiration),
    ...
    const savedComplianceInfo = this.digifranchiseComplianceInfoRepository.save(
