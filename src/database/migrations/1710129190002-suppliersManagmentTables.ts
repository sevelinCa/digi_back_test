...
export class SuppliersManagmentTables1710129190002 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "customer_management" ADD "fullNames" text`);
        await queryRunner.query(`UPDATE "customer_management" SET "fullNames" = 'Default Value' WHERE "fullNames" IS NULL`);
        await queryRunner.query(`ALTER TABLE "customer_management" ALTER COLUMN "fullNames" SET NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "customer_management" DROP COLUMN "fullNames"`);
