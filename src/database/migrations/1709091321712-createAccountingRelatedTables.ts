...
export class CreateAccountingRelatedTables1709091321712
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."expense_arrangement_enum" AS ENUM('cash', 'credit')`,
    );
    await queryRunner.query(
