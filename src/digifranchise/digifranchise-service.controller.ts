...
export class DigifranchiseServiceOfferedController {
  ...
  @ApiOperation({
    summary:
      "GET ALL - Retrieve all Digifranchise service  by Digifranchise ID",
  })
  @ApiResponse({
    status: HttpStatus.OK,
    description:
      "All Digifranchise service  by the specified Digifranchise ID have been successfully retrieved.",
  })
  ...
  async findAllServiceOfferedByDigifranchiseId(
    ...
    return this.digifranchiseService.findAllServiceOfferedByDigifranchiseId(
      digifranchiseId,
    );
  }
  ...
  @Roles(RoleEnum.digifranchise_super_admin)
  @ApiOperation({
    summary: "GET ALL - Retrieve all Digifranchise service by Digifranchise ID",
  })
  @ApiResponse({
    status: HttpStatus.OK,
    description:
  ...
  async getServicesAndSubServicesByDigifranchiseId(
    ...
    return this.digifranchiseService.getServicesAndSubServicesByDigifranchiseId(
      digifranchiseId,
      digifranchiseOwnerId,
    );
  }
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: "You have created subservice.",
  })
  ...
  async createSubDigifranchiseServiceOffered(
    ...
    return this.digifranchiseService.createSubDigifranchiseServiceOffered(
      createDigifranchiseSubServiceOfferedDto,
      userId,
      serviceId,
      digifranchiseOwnerId,
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: "All Sub products  have been successfully retrieved.",
  })
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: "Sub service  has been successfully retrieved.",
  })
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: "Sub service has been successfully updated.",
  })
  ...
  async updateSubService(
    ...
    const userId = (req.user as UserEntity).id;
    return this.digifranchiseService.updateSubService(
      userId,
      id,
      updateDigifranchiseSubServiceDto,
    );
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: "Sub service has been successfully deleted.",
  })
