...
export class DigifranchiseProductController {
  ...
  @ApiOperation({
    summary:
      "GET ALL - Retrieve all Digifranchise products  by Digifranchise ID",
  })
  @ApiResponse({
    status: HttpStatus.OK,
    description:
      "All Digifranchise products  by the specified Digifranchise ID have been successfully retrieved.",
  })
  @Get("get-products/:digifranchiseId")
  @HttpCode(HttpStatus.OK)
  async findAllProductByDigifranchiseId(
  ...
  async getProductsAndSubProductsById(
    ...
    return this.productService.getProductsAndSubProductsById(
      digifranchiseId,
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: "You have created sub product.",
  })
  ...
  async createSubDigifranchiseProduct(
    ...
    return this.productService.createSubDigifranchiseProduct(
      createDigifranchiseSubProductDto,
      userId,
      productId,
      digifranchiseOwnerId,
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: "Sub product  has been successfully retrieved.",
  })
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: "Sub product has been successfully updated.",
  })
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: "Sub product has been successfully deleted.",
  })
