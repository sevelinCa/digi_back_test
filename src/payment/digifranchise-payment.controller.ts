...
export class RateController {
  ...
  @ApiResponse({
    status: 201,
    description: "Rate table has been successfully created.",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "Rate tables have been successfully retrieved.",
  })
  @Get("get-all-rates")
  ...
  @ApiResponse({
    status: 200,
    description: "Rate table has been successfully retrieved.",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "Rate table has been successfully updated.",
  })
  ...
  @ApiResponse({
    status: 204,
    description: "Rate table has been successfully deleted.",
  })
...
export class OrderController {
  ...
  @ApiResponse({
    ...
    description: "Orders have been retrieved.",
  })
  @Get("get-all-order")
  async getAllOrders(
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: "Order has been successfully retrieved.",
  })
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: "Orders have been successfully retrieved.",
  })
  @ApiBearerAuth()
  @UseGuards(AuthGuard("jwt"), RolesGuard)
