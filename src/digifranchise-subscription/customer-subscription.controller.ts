...
export class CustomerSubscriptionController {
  constructor(
    private readonly subscriptionService: CustomerSubscriptionService,
  ) {}
  ...
  @ApiResponse({
    ...
    description: "All subscriptions have been successfully retrieved.",
  })
  @ApiBearerAuth()
  @UseGuards(AuthGuard("jwt"), RolesGuard)
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: "Subscription has been successfully retrieved.",
  })
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: "Subscribers have been successfully retrieved.",
  })
  @Get("get-subscribers/:digifranchiseId")
  async getSubscribersByDigifranchiseId(
    @Param("digifranchiseId") digifranchiseId: string,
  ): Promise<CustomerSubscription[]> {
    return this.subscriptionService.getSubscribersByDigifranchiseId(
      digifranchiseId,
    );
  }
  ...
  async getAllSubscriptionsByOwnedId(
    ...
    return this.subscriptionService.getAllSubscriptionsByOwnedId(
      digifranchiseOwnedId,
    );
  }
