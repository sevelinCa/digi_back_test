...
class ServiceCategoryDto {
    ...
    @ApiProperty({ example: 'A quick wash for your car exterior', required: false })
    @IsOptional()
    @IsString()
    description: string;
}
...
export class CreateDigifranchiseServiceOfferedDto {
    ...
    @ApiProperty({ example: 'A fast and efficient wash for your car', required: false })
    @IsOptional()
    @IsString()
    description: string;
...
export class UpdateDigifranchiseServiceOfferedDto {
    ...
    @ApiProperty({ example: 'An updated description for the service', required: false })
    @IsOptional()
    @IsString()
    description: string;
