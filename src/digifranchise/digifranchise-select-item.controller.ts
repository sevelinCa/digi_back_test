...
export class DigifranchiseSelectItemController {
  constructor(
    private readonly digifranchiseSelectItemService: DigifranchiseSelectItemService,
  ) {}
  ...
  async selectOrUnselectService(
    ...
    return this.digifranchiseSelectItemService.selectOrUnselectService(
      ownerDigifranchiseId,
  ...
  async selectOrUnselectProduct(
    ...
    const userId = (req.user as UserEntity).id;
    return this.digifranchiseSelectItemService.selectOrUnselectProduct(
  ...
  @ApiResponse({
    ...
    description: "All selected services retrieved successfully.",
    type: [DigifranchiseSelectProductOrServiceTable],
  })
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: "All unselected services retrieved successfully.",
    type: [DigifranchiseSelectProductOrServiceTable],
  })
