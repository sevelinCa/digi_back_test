...
export class CreateProfessionalBodyEntitiy1709134166952 implements MigrationInterface {
    name = 'CreateProfessionalBodyEntitiy1709134166952'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "accreditation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "accreditationName" character varying NOT NULL, "professionalBodyId" uuid, CONSTRAINT "PK_1aa1d5e25cfdf9c0f99a74c9157" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "digifranchise_sub_product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "productName" text NOT NULL, "description" text NOT NULL, "unitPrice" character varying(255) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deleteAt" TIMESTAMP, "productId" uuid, "userId" uuid, CONSTRAINT "PK_800edce848e1bcb7658f502ade4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "digifranchise_compliance_info" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "ownedDigifranchiseId" uuid NOT NULL, "companyRegisterationNumber" character varying NOT NULL, "taxNumber" character varying NOT NULL, "taxClearencePin" character varying NOT NULL, "coidaRegisteration" character varying NOT NULL, "uifRegistration" character varying NOT NULL, "workMansCompensation" character varying NOT NULL, "sdlNumber" character varying NOT NULL, "otherComplianceDocs" character varying NOT NULL, "uploadedDocs" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deleteAt" TIMESTAMP, CONSTRAINT "REL_aaf18ed9b15cc56f76043dc0d5" UNIQUE ("ownedDigifranchiseId"), CONSTRAINT "PK_a1fa2dda83341520b251af11b4e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "digifranchise_general_info" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "ownedDigifranchiseId" uuid NOT NULL, "professionalOrganization" character varying NOT NULL, "accreditation" character varying NOT NULL, "renewelDate" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deleteAt" TIMESTAMP, CONSTRAINT "REL_628ee3d8e80b874079732697d6" UNIQUE ("ownedDigifranchiseId"), CONSTRAINT "PK_3e04643b9802b6e9df3c9940334" PRIMARY KEY ("id"))`);
