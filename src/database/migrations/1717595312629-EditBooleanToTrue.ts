...
export class EditBooleanToTrue1717595312629 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "digifranchise_general_info" ADD COLUMN "digifranchisePublishedWithCC" boolean DEFAULT true`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "digifranchise_general_info" ALTER COLUMN "digifranchisePublishedWithCC" SET DEFAULT false`);
