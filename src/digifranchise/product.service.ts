...
export class ProductService {
  ...
  async getProductsAndSubProductsById(
    ...
    const productsWithSubProducts = await Promise.all(
      productsOffered.map(async (product) => {
  ...
  async getSelectedProductsAndSubProductsById(
    digifranchiseId: string,
    digifranchiseOwnerId: string,
  ): Promise<any> {
    const owedFranchise = await this.digifranchiseOwnershipRepository.findOne({
  ...
  async createSubDigifranchiseProduct(
    ...
    const newDigifranchiseSubProduct =
      this.digifranchiseSubProductRepository.create({
        ...createDigifranchiseSubProductDto,
        userId: user,
    ...
    return this.digifranchiseSubProductRepository.save(
      newDigifranchiseSubProduct,
    );
  }

  async getAllSubProduct(userId: string): Promise<DigifranchiseSubProduct[]> {
    return await this.digifranchiseSubProductRepository.find({
  ...
  async getOneSubProductById(
    ...
    const product = await this.digifranchiseSubProductRepository.findOne({
