...
export class UnavailableManagementService {
   ...
   async createUnavailableManagement(userId: string, ownedFranchiseId: string, createUnavailableManagementDto: CreateUnavailableManagementDto): Promise<UnavailableManagement> {
