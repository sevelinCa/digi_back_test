...
export class UpdatingImageTableWithSubServiceAndProductIds1711905985085 implements MigrationInterface {
    name = 'UpdatingImageTableWithSubServiceAndProductIds1711905985085'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "digifranchise_sub_services" DROP CONSTRAINT "FK_6c2af3688c5568733fb22cd8342"`);
        ...
        await queryRunner.query(`ALTER TABLE "digifranchise_sub_services" RENAME COLUMN "digifrachiseServiceId" TO "digifranchiseServiceId"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "digifranchise_sub_services" RENAME COLUMN "digifranchiseServiceId" TO "digifrachiseServiceId"`);
        await queryRunner.query(`ALTER TABLE "customer_subscription" ADD CONSTRAINT "FK_b4059529c205d91c7d138685b55" FOREIGN KEY ("digifranchiseOwnerId") REFERENCES "digifranchise_owner"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "customer_subscription" ADD CONSTRAINT "FK_e54de4b7aba4853d8f0c5540b84" FOREIGN KEY ("digifranchiseId") REFERENCES "digifranchise"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "digifranchise_sub_services" ADD CONSTRAINT "FK_6c2af3688c5568733fb22cd8342" FOREIGN KEY ("digifrachiseServiceId") REFERENCES "digifranchise_service_offered"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
