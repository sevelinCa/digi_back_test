    ...
    private async seedFrienderly() {
        ...
        if (check === 0) {
            const digifranchiseId = this.digifranchiseRepository.create({
                ...
                description: "This digifranchise offers companion care to the elderly. The services are offered within specific areas. Customers can request a free 30-min introductory conversation.",
                status: StatusEnum.active,
            });
