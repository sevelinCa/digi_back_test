...
export class DigifranchiseExpenseController {
  constructor(
    private readonly digifranchiseExpenseService: DigifranchiseExpenseService,
  ) {}

  @ApiOperation({ summary: "CREATE - Create a new digifrachise expense" })
  @ApiResponse({
    status: HttpStatus.CREATED,
    description: "A new expense has been successfully created.",
  })
  ...
  async createDigifranchiseExpense(
    ...
    return this.digifranchiseExpenseService.createDigifranchiseExpense(
      createDigifranchiseExpenseDto,
  ...
  @ApiResponse({
    ...
    description: "All expenses have been successfully retrieved.",
  })
  @Get()
  ...
  async updateDigifranchiseExpense(
    ...
    return this.digifranchiseExpenseService.updateDigifranchiseExpense(
      expenseId,
      updateDigifranchiseExpenseDto,
    );
  }
