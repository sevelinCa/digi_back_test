import { Body, Controller, Get, Post, Param, HttpCode, HttpStatus, Query, Patch, Delete, UseGuards, Request } from '@nestjs/common';
...
export class UserController {
    ...
    async update(
        ...
        const user = await this.userService.updateProfile(request.user, updateUserProfileDto);
        return {
            data: user,
