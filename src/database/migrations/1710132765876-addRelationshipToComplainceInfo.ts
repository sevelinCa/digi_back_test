...
export class AddRelationshipToComplainceInfo1710132765876
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "digifranchise_compliance_info" ADD "ownedDigifranchiseId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "digifranchise_compliance_info" ADD CONSTRAINT "UQ_aaf18ed9b15cc56f76043dc0d5a" UNIQUE ("ownedDigifranchiseId")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "digifranchise_compliance_info" DROP CONSTRAINT "UQ_aaf18ed9b15cc56f76043dc0d5a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "digifranchise_compliance_info" DROP COLUMN "ownedDigifranchiseId"`,
    );
