...
export class RatingOrderController {
  ...
  @ApiResponse({
    ...
    description: "A new rating order has been successfully created.",
  })
  ...
  async createRatingOrder(
    ...
    return this.ratingOrderService.createRatingOrder(
      orderId,
  ...
  async createRatingOrderWithAuth(
    ...
    return this.ratingOrderService.createRatingOrderWithAuth(
      userId,
      orderId,
      createRatingOrderDto,
    );
  ...
  @ApiResponse({
    ...
    description: "All rating orders retrieved successfully.",
  })
  @Get("get-all-ratings")
  ...
  async getAllRatingsByOwnedDigifranchise(
    ...
    return this.ratingOrderService.getAllRatingsByOwnedDigifranchise(
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: "Rating order retrieved successfully.",
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: "Rating order not found.",
  })
  @Get(":ratingId")
  async getRatingOrderById(
  ...
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: "Rating digifrachise not found.",
  })
  @Get(":id/average-rating")
  async getAverageRatingForDigifranchise(
    @Param("id") digifranchiseId: string,
  ): Promise<number> {
    return this.ratingOrderService.getAverageRatingForDigifranchise(
      digifranchiseId,
    );
  }
}
