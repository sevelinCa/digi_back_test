...
export class EditUserProfile1709199166732 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "event_owner" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "deleteAt" TIMESTAMP, "eventId" uuid, "userId" uuid, CONSTRAINT "PK_36367b592f4185fd34f9a444075" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user" ADD "southAfricanCitizen" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ADD "documentId" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ADD "countryOfOrigin" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ADD "policeClearenceCertificate" character varying`,
    );
    await queryRunner.query(`ALTER TABLE "user" ADD "crimes" json`);
    await queryRunner.query(
      `ALTER TABLE "events" ADD CONSTRAINT "FK_9929fa8516afa13f87b41abb263" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "events" ADD CONSTRAINT "FK_0af7bb0535bc01f3c130cfe5fe7" FOREIGN KEY ("venueId") REFERENCES "venue"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "event_owner" ADD CONSTRAINT "FK_0daf227f3b8f8b5b9d3fc43435e" FOREIGN KEY ("eventId") REFERENCES "events"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "event_owner" ADD CONSTRAINT "FK_ddd923fcf2f5a682a512f2c73f6" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "booking" ADD CONSTRAINT "FK_161ef84a823b75f741862a77138" FOREIGN KEY ("eventId") REFERENCES "events"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "event_owner" DROP CONSTRAINT "FK_ddd923fcf2f5a682a512f2c73f6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "event_owner" DROP CONSTRAINT "FK_0daf227f3b8f8b5b9d3fc43435e"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user" DROP COLUMN "policeClearenceCertificate"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "user" DROP COLUMN "southAfricanCitizen"`,
    );
