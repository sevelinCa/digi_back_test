...
export class DigifranchiseImagesController {
  constructor(
    private readonly digifranchiseImagesService: DigifranchiseImagesService,
  ) {}

  @ApiOperation({ summary: "CREATE - Create a new service image" })
  @ApiResponse({
    status: HttpStatus.CREATED,
    description: "A new image has been successfully created.",
  })
  ...
  async createDigifrachiseServiceImage(
    ...
    return this.digifranchiseImagesService.createDigifrachiseServiceImage(
      digifranchiseOwnedId,
      digifranchiseServiceId,
      createDigifranchiseGalleryImageDto,
    );
  }
  ...
  async createDigifrachiseProductImage(
    ...
    return this.digifranchiseImagesService.createDigifrachiseProductImage(
      digifranchiseOwnedId,
      digifranchiseProductId,
      createDigifranchiseGalleryImageDto,
    );
  }
  ...
  async updateImage(
    ...
    return this.digifranchiseImagesService.updateImage(
      imageId,
      updateDigifranchiseGalleryImageDto,
    );
  }
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: "All images have been successfully retrieved.",
  })
  @Get("get-all-images")
